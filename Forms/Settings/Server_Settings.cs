...
namespace Server_Wrapper.Forms {
    public partial class Server_Settings : Form {
        ...
        private void Server_Settings_Load(object sender, EventArgs e) {
            ...
            serverFile.Text = Properties.Settings.Default.serverFile;
        }
        private void saveBtn_Click(object sender, EventArgs e) {
            try {
                ...
                if (Convert.ToInt32(ramMin.Text) > Convert.ToInt32(ramMax.Text)) {
                    ...
                    MessageBox.Show("Save successful.\nPlease restart the server or application to see changes.", "Info", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    return;
                }
            } catch (Exception ex) {
